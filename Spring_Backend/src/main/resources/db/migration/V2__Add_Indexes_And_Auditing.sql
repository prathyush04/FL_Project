...
ALTER TABLE hospital ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE training_session ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
